try:
    from transformers import BartForSequenceOrderingWithMultiPointer
except:
    print(
...
class OrderingModelMulti(Model):
    ...
    def __init__(
        ...
        super().__init__(
            name, BartForSequenceOrderingWithMultiPointer, model_name, tokenizer_name, device, quantization, onnx, onnx_convert_kwargs
        )
